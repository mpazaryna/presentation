...
tools: context7-mcp, WebFetch, Write, Edit
model: haiku
color: blue
---
...
1. **Fetch the URL content** - Use `context7-mcp` as the primary tool with markdown format. If unavailable, fall back to `WebFetch` with a prompt to extract the full documentation content.
